...
Graph 10 hereunder illustrates evolution of average rating for some cohorts. Let's notice once again Cohort 1997.
...
Actually, that script is run to produce cohort analysis for the basic genre "drama" (in WHERE, instructions "m.drama = 1"). I have run that script for all 19 basic genres, simply changing the instruction "m.drama = 1". 
